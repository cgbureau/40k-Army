...
/**
 * Leader eligibility keyword predicates for the emperor-s-children faction.
 * Not yet extracted — populated manually or in a future importer pass.
 */
export const emperorSChildrenLeaderEligibilityKeywordsDataset: SeedDataset<"leader_eligibility_keywords"> = {
