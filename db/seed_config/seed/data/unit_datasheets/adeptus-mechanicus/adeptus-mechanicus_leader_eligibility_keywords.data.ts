...
/**
 * Leader eligibility keyword predicates for the adeptus-mechanicus faction.
 * Not yet extracted — populated manually or in a future importer pass.
 */
export const adeptusMechanicusLeaderEligibilityKeywordsDataset: SeedDataset<"leader_eligibility_keywords"> = {
