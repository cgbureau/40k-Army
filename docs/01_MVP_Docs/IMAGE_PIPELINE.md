...
Image sourcing from retailer CDNs and the Games Workshop CDN proved unreliable
for automated deterministic downloads.

Image acquisition will be implemented in a later phase using a verified image
dataset or curated image source.
...
Images must be downloaded from a retailer CDN where filenames match product
slugs.
...
image URL: <https://elementgames.co.uk/images/products/boyz.jpg>
