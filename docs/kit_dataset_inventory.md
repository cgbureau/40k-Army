...
| `kit_prices` | 2021 | TCGCSV USD observations (all tagged us\_en) plus 7104 legacy price observations across AUD, CAD, CHF, EUR, GBP, PLN, USD | Source by region, currency, source URL, and observed date; all rows must carry a `price_market_id`. |
...
| `kit_prices` (GW direct) | 1062 | GBP/AUD/CAD/EUR/CHF/PLN/NZD/JPY prices scraped live from warhammer.com for matched kits |
...
- The typed seed has 2021 `kit_prices` rows: 631 TCGCSV USD (us\_en), 328 legacy regional, and 1062 GW direct (GBP/AUD/CAD/EUR/CHF/PLN/NZD/JPY) for 133 kits.
