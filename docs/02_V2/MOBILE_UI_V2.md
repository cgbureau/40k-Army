...
It builds on MOBILE_UI_V1.md and introduces a sticky totals system designed to
reduce scrolling friction for mobile users.
...
To prevent users needing to scroll to the bottom of the page to see army totals,
a sticky totals bar is introduced.
...
Mobile users must always be able to see their army totals without scrolling to
the bottom of the page.

The interface should feel responsive, fast, and comfortable for list building on
phones.
