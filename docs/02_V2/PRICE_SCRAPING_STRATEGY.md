...
This document defines how retail price data should be collected for the 40KArmy
calculator.
...
The calculator must support accurate retail price estimation for all purchasable
units.
...
Retailers should not be used as the primary source because they often include
discounts.
...
This ensures the calculator can remain accurate as Games Workshop updates
pricing globally.
...
Maintaining these rules ensures that the calculator remains accurate and
scalable as the dataset grows.
