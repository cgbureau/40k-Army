...
unit, model, weapon, and profile details.
...
| super_faction_id | super_faction |
| ---------------- | ------------- |
| 1                | imperium      |
| 2                | chaos         |
| 3                | xenos         |
...
| rules_faction_id | super_faction_id | rules_faction_name |
| ---------------- | ---------------- | ------------------ |
| 1                | 4                | Space Marines      |
| 2                | 4                | Ultramarines       |
| 3                | 4                | Blood Angels       |
...
| rules_source_id | rules_source_name                                     | rules_source_type      | release_date |
| --------------- | ----------------------------------------------------- | ---------------------- | ------------ |
...
| rules_faction_source_id | rules_faction_id | rules_source_id | source_relationship |
| ----------------------- | ---------------- | --------------- | ------------------- |
| 1                       | 1                | 1               | primary             |
| 2                       | 2                | 1               | primary             |
| 3                       | 3                | 1               | shared_base         |
...
| detachment_id | detachment_name         | rules_source_id |
| ------------- | ----------------------- | --------------- |
...
| rules_faction_detachment_id | rules_faction_id | detachment_id | detachment_access_type |
| --------------------------- | ---------------- | ------------- | ---------------------- |
| 1                           | 1                | 1             | shared                 |
| 2                           | 1                | 2             | shared                 |
| 3                           | 3                | 1             | inherited              |
...
| rules_faction_unit_id | unit_id | rules_faction_id | unit_access_type | rules_source_id |
| --------------------- | ------- | ---------------- | ---------------- | --------------- |
| 1                     | 1       | 1                | shared           | 1               |
| 2                     | 2       | 1                | shared           | 1               |
| 3                     | 3       | 1                | shared           | 1               |
...
fielded as part of units. Epic heroes and named models are represented here so
collections and kit contents can track them directly.

| model_id | model_name                | is_epic |
| -------- | ------------------------- | ------- |
| 1        | Blightlord Champion       | 0       |
| 2        | Blightlord Terminator     | 0       |
| 3        | Captain Titus             | 1       |
| 4        | Ancient Gadriel           | 1       |
| 5        | Veteran Sergeant Metaurus | 1       |
| 6        | Gaius Silva               | 1       |
| 7        | Aemelia Minervas          | 1       |
| 8        | Dainal Kornelius          | 1       |
| 9        | Lucia Vestha              | 1       |
| 10       | Intercessor Sergeant      | 0       |
| 11       | Intercessor               | 0       |
...
| unit_model_id | unit_id | model_id | minimum_model_count | maximum_model_count |
| ------------- | ------- | -------- | ------------------- | ------------------- |
| 1             | 8       | 4        | 1                   | 1                   |
| 2             | 8       | 5        | 1                   | 1                   |
| 3             | 8       | 6        | 1                   | 1                   |
...
| unit_profile_id | game_edition_id | unit_id | model_id | profile_name         | rules_source_id | effective_date |
| --------------- | --------------- | ------- | -------- | -------------------- | --------------- | -------------- |
...
| unit_profile_stat_id | unit_profile_id | stat_key          | stat_value |
| -------------------- | --------------- | ----------------- | ---------- |
| 1                    | 3               | movement          | 6"         |
| 2                    | 3               | toughness         | 4          |
| 3                    | 3               | save              | 3+         |
...
| unit_point_cost_id | game_edition_id | unit_id | rules_source_id | minimum_model_count | maximum_model_count | unit_points | effective_date | superseded_date |
| ------------------ | --------------- | ------- | --------------- | ------------------- | ------------------- | ----------- | -------------- | --------------- |
...
| kit_type_id | kit_type           | multi_unit | number_of_factions |
| ----------- | ------------------ | ---------- | ------------------ |
...
| kit_id | kit                                       | gw_slug                                        | display_name                              | gw_short_slug                             | 40karmy_slug           | model_count | kit_type |
| ------ | ----------------------------------------- | ---------------------------------------------- | ----------------------------------------- | ----------------------------------------- | ---------------------- | ----------- | -------- |
...
| kit_model_id | kit_id | model_id | model_count |
| ------------ | ------ | -------- | ----------- |
| 1            | 1      | 3        | 1           |
| 2            | 1      | 4        | 1           |
| 3            | 1      | 5        | 1           |
...
| kit_price_id | kit_id | currency | price | price_source |
| ------------ | ------ | -------- | ----- | ------------ |
| 1            | 1      | usd      | 94    | gw           |
| 2            | 1      | gbp      | 57    | gw           |
| 3            | 1      | aud      | 160   | gw           |
...
| game_edition_id | game_edition_name              | game_edition_alternate_name | game_edition_slug |
| --------------- | ------------------------------ | --------------------------- | ----------------- |
| 1               | Rogue Trader                   |                             | rt                |
...
| game_size_id | game_size_name | minimum_points | maximum_points | game_edition |
| ------------ | -------------- | -------------- | -------------- | ------------ |
...
| player_id | player_name  | player_username |
| --------- | ------------ | --------------- |
...
| player_army_list_id | player_id | rules_faction_id | detachment_id | faction_display_name | list_name        | game_size_id | points_limit | game_edition_id |
| ------------------- | --------- | ---------------- | ------------- | -------------------- | ---------------- | ------------ | ------------ | --------------- |
...
| player_army_list_unit_id | player_army_list_id | unit_id | selected_model_count | display_name    | points_cost |
| ------------------------ | ------------------- | ------- | -------------------- | --------------- | ----------- |
...
| player_collection_id | player_id | collection_name     |
| -------------------- | --------- | ------------------- |
| 1                    | 1         | Sanguine Angels     |
...
| player_collection_model_id | player_collection_id | rules_faction_id | model_id | model_count |
| -------------------------- | -------------------- | ---------------- | -------- | ----------- |
| 1                          | 1                    | 3                | 10       | 2           |
| 2                          | 1                    | 3                | 11       | 16          |
