...
export const generateMetadata = (): Metadata => ({
  title: "Adeptus Custodes Army Cost (Warhammer 40K) – Full Price Breakdown",
  description:
    "See how much a Warhammer 40K Adeptus Custodes army really costs. Estimate model box prices, list sizes, and total army cost using our calculator.",
});
      ...
      <div className="max-w-6xl w-full mx-auto py-4 px-4 flex flex-col min-h-screen">
        ...
        <main className="max-w-xl mx-auto p-6 flex-grow">
          ...
          <p className="mt-4 text-sm leading-relaxed">
            Building an Adeptus Custodes army in Warhammer 40K can vary in price
            depending on how many elite units, characters, and vehicles you field,
            and whether you keep to a compact force or expand into larger lists.
          </p>
          ...
          <h2 className="mt-4 text-sm font-workbench uppercase">
            Typical Adeptus Custodes Army Cost
          </h2>
          <p className="mt-2 text-sm leading-relaxed">
            At Games Workshop retail prices, a fully built Adeptus Custodes army
            for standard 2000-point games often represents several hundred pounds
            worth of miniatures, with the total driven by how many squads, jetbikes,
            and larger kits you include.
          </p>

          <p className="mt-3 text-sm leading-relaxed">
            Factors such as the number of elite infantry, use of boxed sets,
            inclusion of named characters, and your balance between infantry and
            vehicles all influence the overall spend on a Custodes force.
          </p>

          <p className="mt-3 text-sm leading-relaxed">
            The Warhammer 40K army cost calculator helps you estimate the real cost
            of an Adeptus Custodes army before you buy models, so you can test
