...
export const generateMetadata = (): Metadata => ({
  title: "Thousand Sons Army Cost (Warhammer 40K) – Full Price Breakdown",
  description:
    "See how much a Warhammer 40K Thousand Sons army really costs. Estimate model box prices, list sizes, and total army cost using our calculator.",
});
      ...
      <div className="max-w-6xl w-full mx-auto py-4 px-4 flex flex-col min-h-screen">
        ...
        <main className="max-w-xl mx-auto p-6 flex-grow">
          ...
          <p className="mt-4 text-sm leading-relaxed">
            Building a Thousand Sons army in Warhammer 40K can vary in price
            depending on how many Rubric Marines, Scarab Occult Terminators,
            characters, and daemon allies you decide to include.
          </p>
          ...
          <h2 className="mt-4 text-sm font-workbench uppercase">
            Typical Thousand Sons Army Cost
          </h2>
          <p className="mt-2 text-sm leading-relaxed">
            At Games Workshop retail prices, a 2000-point Thousand Sons army often
            represents several hundred pounds in miniatures, with the total affected
            by how many elite units, characters, and larger kits you field.
          </p>

          <p className="mt-3 text-sm leading-relaxed">
            The number of Rubric squads, Scarab Occult Terminators, sorcerers, boxed
            sets, and any daemon support all play a part in the overall cost of
            bringing a Thousand Sons warband to the table.
          </p>

          <p className="mt-3 text-sm leading-relaxed">
            The Warhammer 40K army cost calculator helps you estimate the real cost
            of a Thousand Sons force before you buy models, letting you compare
            different list ideas and their impact on both points and budget.
          </p>
