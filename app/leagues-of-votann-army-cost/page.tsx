...
export const generateMetadata = (): Metadata => ({
  title: "Leagues of Votann Army Cost (Warhammer 40K) – Full Price Breakdown",
  description:
    "See how much a Warhammer 40K Leagues of Votann army really costs. Estimate model box prices, list sizes, and total army cost using our calculator.",
});
      ...
      <div className="max-w-6xl w-full mx-auto py-4 px-4 flex flex-col min-h-screen">
        ...
        <main className="max-w-xl mx-auto p-6 flex-grow">
          ...
          <p className="mt-4 text-sm leading-relaxed">
            Building a Leagues of Votann army in Warhammer 40K can vary in price
            depending on how many Hearthkyn squads, elite units, and vehicles you
            bring, and whether you run compact patrols or full 2000-point forces.
          </p>
          ...
          <h2 className="mt-4 text-sm font-workbench uppercase">
            Typical Leagues of Votann Army Cost
          </h2>
          <p className="mt-2 text-sm leading-relaxed">
            At Games Workshop retail prices, a 2000-point Leagues of Votann army
            usually totals several hundred pounds in miniatures, with the exact cost
            shaped by how many infantry squads, characters, and heavy kits you add.
          </p>

          <p className="mt-3 text-sm leading-relaxed">
            The combination of Hearthkyn, elite units, support characters, boxed
            sets, and vehicles all contributes to the overall price of building a
            full Leagues of Votann force.
          </p>

          <p className="mt-3 text-sm leading-relaxed">
            The Warhammer 40K army cost calculator helps you estimate the real cost
            of a Leagues of Votann army before you start buying models, so you can
            explore different builds and keep your budget in mind.
          </p>
